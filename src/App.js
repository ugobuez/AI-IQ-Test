...
function App() {
  ...
  async function loadQuestions() {
    try {
      ...
      const combined = [...questionsData, ...aiQuestions];
    ...
    return (
      <div className="container text-center mt-5">
        <div className="card shadow-lg p-5">
          ...
          <p className="fs-5">
            Test your intelligence with professional cognitive questions.
          </p>

          <p>
            ⏱ Time Limit: 8 minutes <br />
  ...
  return (
    <div className="container mt-5">
      <div className="card shadow-lg p-4 quiz-card">
        ...
        {/* ✅ SAFE VERSION (VERY IMPORTANT) */}
        <QuestionCard
          question={questions[current]?.question || "Loading question..."}
